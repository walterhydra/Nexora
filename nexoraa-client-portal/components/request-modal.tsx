          ...
          >
                    ...
                    <button
                      ...
                      className={`flex-1 py-1.5 rounded-lg text-xs font-medium transition-all duration-200 border ${
                        priority === p
                          ...
                          : "bg-transparent text-[#64748B] border-[#1E1E2E] hover:border-[#2a2a3e]"
                      }`}
                    >
                      {p}
                    </button>
            ...
            <div className="px-5 pb-5">
              <button
                ...
                className="w-full py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-white text-sm font-semibold transition-all duration-200 flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-indigo-500/25"
              >
                {loading ? (
