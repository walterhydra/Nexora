          ...
          {pricing.map((plan, idx) => (
            ...
            >
              ...
              <GlowCard className={`h-full p-6 flex flex-col ${plan.popular ? 'border-accent-blue/50 ring-1 ring-accent-blue/50' : ''}`}>
                ...
                <MagneticButton className={`w-full justify-center text-xs py-2 ${plan.popular ? 'bg-white text-black hover:bg-gray-100' : 'bg-white dark:bg-black text-gray-900 dark:text-white dark:bg-white/10 dark:hover:bg-white/20'}`}>
