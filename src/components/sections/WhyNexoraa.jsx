...
const WhyNexoraa = () => {
  console.log("WhyNexoraa Component Loaded - v2");
      ...
      >
        <div className="mb-24 text-center">
          ...
          >
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest text-[var(--text-primary)] opacity-60">The Nexoraa Advantage</span>
          </m.div>
          ...
          >
            Why Choose <br/>
            <span className="text-gradient">Nexoraa Studio?</span>
          </m.h2>
