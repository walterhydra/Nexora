                ...
                <div className="px-4 pb-2">
                  ...
                  {recentItems.map((item) => {
                    ...
                    return (
                      <button
                        key={item.id}
                        onClick={() => { setActivePage(item.id); setCommandOpen(false) }}
                        className="w-full flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-white/5 text-[#64748B] hover:text-white transition-colors text-sm text-left bg-transparent border-0 cursor-pointer"
                      >
                        <Icon size={15} />
                  ...
                  {items.map((item) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          "w-full flex items-center gap-3 px-3 py-2 rounded-lg transition-colors text-sm text-left bg-transparent border-0 cursor-pointer",
                          selected === idx
